...
class Skyblock(commands.Cog):
    ...
    @commands.group(name="reminder", description="Set a reminder for an event. The bot will message you 5 minutes before it.", aliases=["rem", "r"], usage="[set/remove/list]", invoke_without_command=True)
